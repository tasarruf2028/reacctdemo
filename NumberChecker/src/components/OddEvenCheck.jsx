...
const OddEvenCheck = () => {
    ...
    const checkOddEven = () => {
        ...
        if(isNaN(numValue)){
            ...
            setResult(`The number ${numValue} is even`)
        } else {
            setResult(`The number ${numValue} is Odd`)
        }
    }
  ...
  return (
    <div className='m-4'>
      <div className='w-110 bg-white rounded py-4 px-6 shadow-xl'>
        <h1 className='text-3xl font-medium text-gray-800 text-center mb-4'>Odd Even Checker</h1>
